    ...
    : QMainWindow(parent)
{
    ...
    setWindowIcon(QIcon(":/images/images/fluctu_opt.png"));

    /** Ajout d'une image à l'ouverture de l'application */
    QLabel* image = new QLabel(this);
    image->setPixmap(QPixmap(":/images/images/fluctu2.png"));
    image->move(350,100);
    ...
    helpAct->setIcon(QIcon(":/images/images/fluctu_opt.png"));

    /** Le menu FAQ */
    aideAct = aboutMenu->addAction( "FAQ", this, SLOT(Aide()) ) ;
    aideAct->setIcon(QIcon(":/images/images/interro.png"));
